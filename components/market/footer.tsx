        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm text-gray-500">
              Discover a world of convenience and affordability at Borce Store.
              From fashion to electronics, we&apos;ve got everything you need to
              upgrade your lifestyle. Explore our wide range of products today!
            </p>
