...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-10 py-2.5 px-10 flex  gap-2 justify-between items-center bg-white max-sm:px-2">
      <Link href="/">
        ...
        <Sheet>
          ...
          <SheetContent>
            <div className="flex flex-col gap-y-6">
              <Link href="/" className="hover:text-blue-1 text-heading4-medium">
                Home
              </Link>
              <Link
                href={user ? "/wishlist" : "/sign-in"}
